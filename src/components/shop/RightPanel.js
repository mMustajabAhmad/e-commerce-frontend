...
function RightPanel(props){
    ...
    return (
        <div>
            <button type="button" className="border rounded  pl-4 pr-3 py-2 hover:bg-purple-700 hover:text-white w-1/4" onClick={handleClick} style={{marginTop: "13%"}}>
                default
                 <div className="float-right ml-12 mr-2"><i className='fa fa-angle-down '></i></div>
            </button>
            {menuClicked &&
             <div className="border rounded mt-1 p-2 w-1/4">
