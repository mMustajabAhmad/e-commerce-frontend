  ...
  return (
    <>
      <div className="flex flex-row bg-slate-200 rounded p-2 justify-between pr-4 mb-2">
        <div className="flex flex-col bg-orange-700 w-[3px] mr-3 rounded"></div>
        <div className="flex flex-col gap-2">
          <div className="flex flex-row">
          <span className="text-lg font-medium ">Order # {point.order_id}</span>
        ...
        <div className="flex flex-col ml-2">
            <div className=" flex flex-row items-center font-medium">
              <FaMinus className="text-orange-700"/>
              <span className="text-orange-700 text-xl">{point.number_of_points}</span>
