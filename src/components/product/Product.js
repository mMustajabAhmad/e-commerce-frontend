        ...
        <main className="flex flex-col min-h-screen">
          ...
          >
            ...
            <div className="flex flex-col" style={{ marginLeft: "10%" }}>
              ...
              <p className="text-1xl fornt-bold  mt-2">
                <b>Selected Size: </b>
              ...
              <div className="flex flex-row">
                <button
                  className="border bg-black text-white mt-6 hover:bg-purple-700"
                ...
                <button
                  className="border bg-black text-white mt-6 hover:bg-purple-700 ml-2"
                  style={{ height: "50px", width: "200px" }}
                >
